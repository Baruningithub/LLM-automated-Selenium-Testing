...
system_prompt_choices = {
    ...
    page URL which you can directly use as get URL. Use http try and exceptions for the pages, also add time 
    sleeps after input send keys and for web waiting.''',
